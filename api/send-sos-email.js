// API endpoint for sending SOS emails using Resend
...
export default async function handler(req, res) {
  ...
  try {
    const { to, userInfo, location, message, timestamp } = req.body;
    ...
    const emailData = {
      from: 'CareConnect Emergency <emergency@careconnect.app>',
      to: [to],
